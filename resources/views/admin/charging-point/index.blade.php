            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <div class="col-md-7 text-center text-md-right">
                                <a href="{{ url('charging-point/create') }}" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i>Add Chargin Point</a>
                    ...
                    <div id="js-admin-partial-target">
                        <include-fragment src="charging-point/fetch">
